...
class UserSignup : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        u_register.setOnClickListener {
            ...
            registerUser(email, password,name,number,studentid)
    ...
    private fun addUser(email: String,password: String,name:String,number:String,studentId:String){


        ref = FirebaseDatabase.getInstance().reference
        val userId= (ref.push().key).toString()
        val addUser = Data(userId,email,password,name,number,studentId)
